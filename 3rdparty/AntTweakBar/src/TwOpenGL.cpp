...
typedef void( APIENTRY* PFNGLTexImage3D )( GLenum target,
                                           GLint level,
...
typedef void( APIENTRY* PFNGLBlendEquationSeparate )( GLenum srcMode,
                                                      GLenum dstMode );
typedef void( APIENTRY* PFNGLBlendFuncSeparate )( GLenum srcRGB,
                                                  GLenum dstRGB,
                                                  GLenum srcAlpha,
                                                  GLenum dstAlpha );
...
static GLuint BindFont( const CTexFont* _Font ) {
    ...
    _glTexImage2D( GL_TEXTURE_2D, 0, 4, _Font->m_TexWidth, _Font->m_TexHeight,
                   0, GL_ALPHA, GL_UNSIGNED_BYTE, _Font->m_TexBytes );
...
int CTwGraphOpenGL::Init() {
    ...
    // Get extensions
    _glBindBufferARB = reinterpret_cast< PFNGLBindBufferARB >(
        _glGetProcAddress( "glBindBufferARB" ) );
    _glBindProgramARB = reinterpret_cast< PFNGLBindProgramARB >(
        _glGetProcAddress( "glBindProgramARB" ) );
    _glGetHandleARB = reinterpret_cast< PFNGLGetHandleARB >(
        _glGetProcAddress( "glGetHandleARB" ) );
    _glUseProgramObjectARB = reinterpret_cast< PFNGLUseProgramObjectARB >(
        _glGetProcAddress( "glUseProgramObjectARB" ) );
    _glTexImage3D = reinterpret_cast< PFNGLTexImage3D >(
        _glGetProcAddress( "glTexImage3D" ) );
    _glActiveTextureARB = reinterpret_cast< PFNGLActiveTextureARB >(
        _glGetProcAddress( "glActiveTextureARB" ) );
    _glClientActiveTextureARB = reinterpret_cast< PFNGLClientActiveTextureARB >(
        _glGetProcAddress( "glClientActiveTextureARB" ) );
    _glBlendEquation = reinterpret_cast< PFNGLBlendEquation >(
        _glGetProcAddress( "glBlendEquation" ) );
    _glBlendEquationSeparate = reinterpret_cast< PFNGLBlendEquationSeparate >(
        _glGetProcAddress( "glBlendEquationSeparate" ) );
    _glBlendFuncSeparate = reinterpret_cast< PFNGLBlendFuncSeparate >(
        _glGetProcAddress( "glBlendFuncSeparate" ) );
    _glBindVertexArray = reinterpret_cast< PFNGLBindVertexArray >(
        _glGetProcAddress( "glBindVertexArray" ) );
    _glEnableVertexAttribArray =
        reinterpret_cast< PFNGLEnableVertexAttribArray >(
            _glGetProcAddress( "glEnableVertexAttribArray" ) );
    _glDisableVertexAttribArray =
        reinterpret_cast< PFNGLDisableVertexAttribArray >(
            _glGetProcAddress( "glDisableVertexAttribArray" ) );
    _glGetVertexAttribiv = reinterpret_cast< PFNGLGetVertexAttribiv >(
...
void CTwGraphOpenGL::BeginDraw( int _WndWidth, int _WndHeight ) {
    ...
    if ( !s_SupportTexRectChecked ) {
        ...
        if ( ext != 0 && strlen( ext ) > 0 )
            m_SupportTexRect =
                ( strstr( ext, "GL_ARB_texture_rectangle" ) != NULL );
    ...
    if ( _glActiveTextureARB ) {
        ...
        _glGetIntegerv( GL_CLIENT_ACTIVE_TEXTURE_ARB,
                        &m_PrevClientActiveTextureARB );
        GLint maxTexUnits = 1;
        _glGetIntegerv( GL_MAX_TEXTURE_COORDS,
                        &maxTexUnits ); // was GL_MAX_TEXTURE_UNITS_ARB
        if ( maxTexUnits < 1 )
            maxTexUnits = 1;
        ...
        for ( i = 0; i < maxTexUnits; i++ ) {
            ...
            m_PrevClientTexCoordArray[ i ] =
                _glIsEnabled( GL_TEXTURE_COORD_ARRAY );
    ...
    _glLoadIdentity();
    //_glOrtho(Vp[0], Vp[0]+Vp[2]-1, Vp[1]+Vp[3]-1, Vp[1], -1, 1); // Doesn't
    work _glOrtho(Vp[0], Vp[0]+Vp[2], Vp[1]+Vp[3], Vp[1], -1, 1);
    */
    if ( _WndWidth > 0 && _WndHeight > 0 ) {
        Vp[ 0 ] = 0;
        Vp[ 1 ] = 0;
    ...
    if ( _glBindBufferARB != NULL ) {
        ...
        _glGetIntegerv( GL_ELEMENT_ARRAY_BUFFER_BINDING_ARB,
    ...
    if ( _glDisableVertexAttribArray != NULL ) {
        ...
        for ( int i = 0; i < maxVertexAttribs; i++ ) {
            _glGetVertexAttribiv( i, GL_VERTEX_ATTRIB_ARRAY_ENABLED,
                                  &m_PrevEnabledVertexAttrib[ i ] );
...
void CTwGraphOpenGL::EndDraw() {
    ...
    if ( _glBlendEquationSeparate != NULL )
        _glBlendEquationSeparate( m_PrevBlendEquationRGB,
                                  m_PrevBlendEquationAlpha );
    if ( _glBlendFuncSeparate != NULL )
        _glBlendFuncSeparate( m_PrevBlendSrcRGB, m_PrevBlendDstRGB,
                              m_PrevBlendSrcAlpha, m_PrevBlendDstAlpha );
...
void CTwGraphOpenGL::DrawLine( int _X0,
                               int _Y0,
                               int _X1,
                               int _Y1,
                               color32 _Color0,
    ...
    */
    ...
    _glLoadIdentity();
    _glBegin( GL_LINES );
    _glColor4ub( GLubyte( _Color0 >> 16 ), GLubyte( _Color0 >> 8 ),
                 GLubyte( _Color0 ), GLubyte( _Color0 >> 24 ) );
    _glVertex2f( ( GLfloat )_X0 + dx, ( GLfloat )_Y0 + dy );
    _glColor4ub( GLubyte( _Color1 >> 16 ), GLubyte( _Color1 >> 8 ),
                 GLubyte( _Color1 ), GLubyte( _Color1 >> 24 ) );
...
void CTwGraphOpenGL::DrawRect( int _X0,
                               int _Y0,
                               int _X1,
                               int _Y1,
                               color32 _Color00,
    ...
    */
    ...
    _glVertex2f( ( GLfloat )_X0 + dx, ( GLfloat )_Y0 + dy );
    _glColor4ub( GLubyte( _Color10 >> 16 ), GLubyte( _Color10 >> 8 ),
                 GLubyte( _Color10 ), GLubyte( _Color10 >> 24 ) );
    _glVertex2f( ( GLfloat )_X1 + dx, ( GLfloat )_Y0 + dy );
    _glColor4ub( GLubyte( _Color11 >> 16 ), GLubyte( _Color11 >> 8 ),
                 GLubyte( _Color11 ), GLubyte( _Color11 >> 24 ) );
    _glVertex2f( ( GLfloat )_X1 + dx, ( GLfloat )_Y1 + dy );
    _glColor4ub( GLubyte( _Color01 >> 16 ), GLubyte( _Color01 >> 8 ),
                 GLubyte( _Color01 ), GLubyte( _Color01 >> 24 ) );
...
void CTwGraphOpenGL::BuildText( void* _TextObj,
    ...
    for ( int Line = 0; Line < _NbLines; ++Line ) {
        ...
        if ( _LineColors != NULL )
            LineColor = ( _LineColors[ Line ] & 0xff00ff00 ) |
                        GLubyte( _LineColors[ Line ] >> 16 ) |
                        ( GLubyte( _LineColors[ Line ] ) << 16 );
        ...
        for ( i = 0; i < Len; ++i ) {
            ...
            TextObj->m_TextUVs.push_back(
                Vec2( _Font->m_CharU0[ ch ], _Font->m_CharV0[ ch ] ) );
            TextObj->m_TextUVs.push_back(
                Vec2( _Font->m_CharU1[ ch ], _Font->m_CharV0[ ch ] ) );
            TextObj->m_TextUVs.push_back(
                Vec2( _Font->m_CharU0[ ch ], _Font->m_CharV1[ ch ] ) );
            TextObj->m_TextUVs.push_back(
                Vec2( _Font->m_CharU1[ ch ], _Font->m_CharV0[ ch ] ) );
            TextObj->m_TextUVs.push_back(
                Vec2( _Font->m_CharU1[ ch ], _Font->m_CharV1[ ch ] ) );
            TextObj->m_TextUVs.push_back(
                Vec2( _Font->m_CharU0[ ch ], _Font->m_CharV1[ ch ] ) );
        ...
        if ( _BgWidth > 0 ) {
            ...
            if ( _LineBgColors != NULL ) {
                color32 LineBgColor =
                    ( _LineBgColors[ Line ] & 0xff00ff00 ) |
                    GLubyte( _LineBgColors[ Line ] >> 16 ) |
                    ( GLubyte( _LineBgColors[ Line ] ) << 16 );
...
void CTwGraphOpenGL::DrawText( void* _TextObj,
                               int _X,
                               int _Y,
                               color32 _Color,
                               color32 _BgColor ) {
    ...
    if ( ( _BgColor != 0 ||
           TextObj->m_BgColors.size() == TextObj->m_BgVerts.size() ) &&
         TextObj->m_BgVerts.size() >= 4 ) {
        _glDisable( GL_TEXTURE_2D );
        _glVertexPointer( 2, GL_FLOAT, 0, &( TextObj->m_BgVerts[ 0 ] ) );
        if ( TextObj->m_BgColors.size() == TextObj->m_BgVerts.size() &&
             _BgColor == 0 ) {
            _glEnableClientState( GL_COLOR_ARRAY );
            _glColorPointer( 4, GL_UNSIGNED_BYTE, 0,
                             &( TextObj->m_BgColors[ 0 ] ) );
        } else {
            _glDisableClientState( GL_COLOR_ARRAY );
            _glColor4ub( GLubyte( _BgColor >> 16 ), GLubyte( _BgColor >> 8 ),
                         GLubyte( _BgColor ), GLubyte( _BgColor >> 24 ) );
        }
    ...
    if ( TextObj->m_TextVerts.size() >= 4 ) {
        ...
        if ( TextObj->m_Colors.size() == TextObj->m_TextVerts.size() &&
             _Color == 0 ) {
            _glEnableClientState( GL_COLOR_ARRAY );
            _glColorPointer( 4, GL_UNSIGNED_BYTE, 0,
                             &( TextObj->m_Colors[ 0 ] ) );
            ...
            _glDisableClientState( GL_COLOR_ARRAY );
            _glColor4ub( GLubyte( _Color >> 16 ), GLubyte( _Color >> 8 ),
                         GLubyte( _Color ), GLubyte( _Color >> 24 ) );
        }
...
void CTwGraphOpenGL::ChangeViewport( int _X0,
                                     int _Y0,
                                     int _Width,
                                     int _Height,
                                     int _OffsetX,
    ...
    if ( _Width > 0 && _Height > 0 ) {
        ...
        vp[ 2 ] = _Width - 1;
        vp[ 3 ] = _Height - 1;
        _glViewport( vp[ 0 ], m_WndHeight - vp[ 1 ] - vp[ 3 ], vp[ 2 ],
                     vp[ 3 ] );
        ...
        _glMatrixMode( GL_PROJECTION );
        _glLoadIdentity();
        _glOrtho( _OffsetX, _OffsetX + vp[ 2 ], vp[ 3 ] - _OffsetY, -_OffsetY,
                  -1, 1 );
...
void CTwGraphOpenGL::RestoreViewport() {
    _glViewport( m_ViewportInit[ 0 ], m_ViewportInit[ 1 ], m_ViewportInit[ 2 ],
                 m_ViewportInit[ 3 ] );
...
void CTwGraphOpenGL::DrawTriangles( int _NumTriangles,
                                    int* _Vertices,
                                    color32* _Colors,
                                    Cull _CullMode ) {
    assert( m_Drawing == true );
    ...
    for ( int i = 0; i < 3 * _NumTriangles; ++i ) {
        ...
        _glColor4ub( GLubyte( col >> 16 ), GLubyte( col >> 8 ), GLubyte( col ),
                     GLubyte( col >> 24 ) );
        _glVertex2f( ( GLfloat )_Vertices[ 2 * i + 0 ] + dx,
                     ( GLfloat )_Vertices[ 2 * i + 1 ] + dy );
    }
    _glEnd();
