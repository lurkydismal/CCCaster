...
int TW_CALL
TwEventSDL12( const void* sdlEvent ); // implemented in TwEventSDL12.c
int TW_CALL
TwEventSDL13( const void* sdlEvent ); // implmeneted in TwEventSDL13.c
#ifdef __cplusplus
extern "C" {
...
int TW_CALL TwEventSDL( const void* sdlEvent,
    ...
    if ( majorVersion < 1 || ( majorVersion == 1 && minorVersion < 2 ) ) {
        ...
        return TwEventSDL13( sdlEvent ); // will probably not work for version
                                         // > 1.3, but give it a chance
}
