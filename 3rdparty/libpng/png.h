...
typedef void( PNGAPI* png_error_ptr )
    PNGARG( ( png_structp, png_const_charp ) );
typedef void( PNGAPI* png_rw_ptr )
    PNGARG( ( png_structp, png_bytep, png_size_t ) );
...
typedef void( PNGAPI* png_progressive_info_ptr )
    PNGARG( ( png_structp, png_infop ) );
typedef void( PNGAPI* png_progressive_end_ptr )
    PNGARG( ( png_structp, png_infop ) );
...
PNG_EXPORT( void, png_info_init_3 )
...
#ifdef PNG_FLOATING_POINT_SUPPORTED
PNG_EXPORT( void, png_set_rgb_to_gray )
...
PNG_EXPORT( int, png_set_interlace_handling ) PNGARG( ( png_structp png_ptr ) );
    ...
    defined( PNG_WRITE_INVERT_SUPPORTED )
...
#ifdef PNG_FLOATING_POINT_SUPPORTED
PNG_EXPORT( void, png_set_background )
PNGARG( ( png_structp png_ptr,
 ...
 */
#ifdef PNG_FLOATING_POINT_SUPPORTED
PNG_EXPORT( void, png_set_filter_heuristics )
PNGARG( ( png_structp png_ptr,
...
PNG_EXPORT( png_voidp, png_get_user_chunk_ptr )
PNGARG( ( png_const_structp png_ptr ) );
#endif
...
PNG_EXPORT( png_voidp, png_malloc )
PNGARG( ( png_structp png_ptr, png_alloc_size_t size ) ) PNG_ALLOCATED;
/* Added at libpng version 1.4.0 */
PNG_EXPORT( png_voidp, png_calloc )
PNGARG( ( png_structp png_ptr, png_alloc_size_t size ) ) PNG_ALLOCATED;

/* Added at libpng version 1.2.4 */
PNG_EXPORT( png_voidp, png_malloc_warn )
PNGARG( ( png_structp png_ptr, png_alloc_size_t size ) ) PNG_ALLOCATED;
...
PNGARG( ( png_structp png_ptr, png_alloc_size_t size ) ) PNG_ALLOCATED;
PNG_EXPORT( void, png_free_default )
PNGARG( ( png_structp png_ptr, png_voidp ptr ) );
#endif

#ifndef PNG_NO_ERROR_TEXT
/* Fatal error in PNG image of libpng - can't continue */
PNG_EXPORT( void, png_error )
PNGARG( ( png_structp png_ptr, png_const_charp error_message ) ) PNG_NORETURN;

/* The same, but the chunk name is prepended to the error string. */
PNG_EXPORT( void, png_chunk_error )
PNGARG( ( png_structp png_ptr, png_const_charp error_message ) ) PNG_NORETURN;
...
PNGARG( ( png_structp png_ptr, int allowed ) );
#endif
...
PNGARG( ( png_const_structp png_ptr, png_infop info_ptr ) );
...
#ifdef PNG_cHRM_SUPPORTED
#ifdef PNG_FLOATING_POINT_SUPPORTED
PNG_EXPORT( png_uint_32, png_get_cHRM )
PNGARG( ( png_const_structp png_ptr,
          png_const_infop info_ptr,
          double* white_x,
          double* white_y,
...
#endif
#ifdef PNG_FIXED_POINT_SUPPORTED
PNG_EXPORT( png_uint_32, png_get_cHRM_fixed )
PNGARG( ( png_const_structp png_ptr,
          png_const_infop info_ptr,
...
#endif
#ifdef PNG_FIXED_POINT_SUPPORTED
PNG_EXPORT( void, png_set_cHRM_fixed )
PNGARG( ( png_structp png_ptr,
          png_infop info_ptr,
          png_fixed_point int_white_x,
          png_fixed_point int_white_y,
...
#ifdef PNG_FLOATING_POINT_SUPPORTED
PNG_EXPORT( png_uint_32, png_get_gAMA )
PNGARG( ( png_const_structp png_ptr,
          png_const_infop info_ptr,
          double* file_gamma ) );
#endif
PNG_EXPORT( png_uint_32, png_get_gAMA_fixed )
PNGARG( ( png_const_structp png_ptr,
          png_const_infop info_ptr,
...
PNGARG( ( png_const_structp png_ptr, png_const_infop info_ptr, int* intent ) );
#endif
...
#ifdef PNG_sPLT_SUPPORTED
PNG_EXPORT( png_uint_32, png_get_sPLT )
PNGARG( ( png_const_structp png_ptr,
          png_const_infop info_ptr,
...
PNG_EXPORT( png_uint_32, png_get_text )
PNGARG( ( png_const_structp png_ptr,
          png_const_infop info_ptr,
          png_textp* text_ptr,
          int* num_text ) );
...
#ifdef PNG_sCAL_SUPPORTED
#ifdef PNG_FLOATING_POINT_SUPPORTED
PNG_EXPORT( png_uint_32, png_get_sCAL )
PNGARG( ( png_const_structp png_ptr,
          png_const_infop info_ptr,
          int* unit,
          double* width,
...
PNG_EXPORT( png_uint_32, png_get_unknown_chunks )
PNGARG( ( png_const_structp png_ptr,
          png_const_infop info_ptr,
...
PNG_EXPORT( png_charp, png_get_copyright )
PNGARG( ( png_const_structp png_ptr ) );
PNG_EXPORT( png_charp, png_get_header_ver )
PNGARG( ( png_const_structp png_ptr ) );
PNG_EXPORT( png_charp, png_get_header_version )
PNGARG( ( png_const_structp png_ptr ) );
PNG_EXPORT( png_charp, png_get_libpng_ver )
PNGARG( ( png_const_structp png_ptr ) );
...
PNG_EXPORT( void, png_set_strip_error_numbers )
...
PNGARG( ( png_structp png_ptr, png_uint_32 user_chunk_cache_max ) );
PNG_EXPORT( png_uint_32, png_get_chunk_cache_max )
PNGARG( ( png_const_structp png_ptr ) );
/* Added in libpng-1.4.1 */
PNG_EXPORT( void, png_set_chunk_malloc_max )
PNGARG( ( png_structp png_ptr, png_alloc_size_t user_chunk_cache_max ) );
...
#define png_composite( composite, fg, alpha, bg )                          \
    ( composite ) =                                                        \
        ( png_byte )( ( ( png_uint_16 )( fg ) * ( png_uint_16 )( alpha ) + \
                        ( png_uint_16 )( bg ) *                            \
                            ( png_uint_16 )( 255 -                         \
                                             ( png_uint_16 )( alpha ) ) +  \
                        ( png_uint_16 )127 ) /                             \
