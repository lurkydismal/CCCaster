...
/* Added at libpng version 1.4.0 */
#if !defined( PNG_NO_ALIGNED_MEMORY ) && \
...
#if !defined( PNG_NO_SETJMP ) && !defined( PNG_SETJMP_NOT_SUPPORTED ) && \
    !defined( PNG_NO_SETJMP_SUPPORTED )
...
#define PNG_READ_OPT_PLTE_SUPPORTED /* only affects support of the */
    ...
    defined( PNG_READ_tEXt_SUPPORTED ) || defined( PNG_READ_zTXt_SUPPORTED )
#define PNG_READ_TEXT_SUPPORTED
#define PNG_TEXT_SUPPORTED
#endif
...
#define PNG_zTXt_SUPPORTED
    ...
    defined( PNG_WRITE_tEXt_SUPPORTED ) || defined( PNG_WRITE_zTXt_SUPPORTED )
#define PNG_WRITE_TEXT_SUPPORTED
#ifndef PNG_TEXT_SUPPORTED
#define PNG_TEXT_SUPPORTED
#endif
...
#if !defined( PNG_DLL ) && \
    ( defined( PNG_BUILD_DLL ) || defined( PNG_USE_DLL ) )
#define PNG_DLL
#endif
...
#if !defined( PNG_IMPEXP ) && defined( PNG_BUILD_DLL ) && \
    !defined( PNG_NO_MODULEDEF )
#define PNG_IMPEXP
#endif
