...
/* Window handling */
GLFWAPI int GLFWAPIENTRY glfwOpenWindow( int width,
                                         int height,
                                         int redbits,
                                         int greenbits,
                                         int bluebits,
...
glfwSetWindowCloseCallback( GLFWwindowclosefun cbfun );
GLFWAPI void GLFWAPIENTRY
...
GLFWAPI void GLFWAPIENTRY glfwWaitCond( GLFWcond cond,
                                        GLFWmutex mutex,
                                        double timeout );
...
GLFWAPI int GLFWAPIENTRY glfwReadImage( const char* name,
                                        GLFWimage* img,
                                        int flags );
GLFWAPI int GLFWAPIENTRY glfwReadMemoryImage( const void* data,
                                              long size,
                                              GLFWimage* img,
                                              int flags );
...
GLFWAPI int GLFWAPIENTRY glfwLoadMemoryTexture2D( const void* data,
                                                  long size,
                                                  int flags );
