...
// If user have their own definition, can define RAPIDJSON_NO_INT64DEFINE to
// disable this.
...
/*!	GCC provided macro for detecting endianness of the target machine. But
...
#define RAPIDJSON_ENDIAN \
    RAPIDJSON_LITTLEENDIAN // Assumes little endian otherwise.
#endif
...
namespace rapidjson {
//! Use 32-bit array/string indices even for 64-bit platform, instead of using
//! size_t.
...
/*! \class rapidjson::Allocator
        ...
        So if an allocator need to support Free(), it needs to put its pointer
in the header of memory block.

\code
concept Allocator {
        static const bool kNeedFree;	//!< Whether this allocator needs to
call Free().
        ...
        // \param originalPtr The pointer to current memory block. Null_ pointer
is permitted.
    ...
    */
    ...
    /*! The user buffer will be used firstly. When it is full, memory pool
       ...
       destructed.
            ...
            \param size Size of the buffer in bytes. It must at least larger
       than sizeof(ChunkHeader).
            \param chunkSize The size of memory chunk. The default is
       kDefaultChunkSize.
            \param baseAllocator The allocator for allocating memory chunks.
    */
    ...
    void* Malloc( size_t size ) {
        ...
        RAPIDJSON_ASSERT( ( ( uintptr_t )buffer & 3 ) ==
...
concept Encoding {
        ...
        //! \param buffer pointer to destination buffer to store the result. It
should have sufficient size of encoding one character.
...
/*! http://en.wikipedia.org/wiki/UTF-16
        \tparam CharType Type for storing 16-bit UTF-16 data. Default is
   wchar_t. C++11 may use char16_t instead.
        \implements Encoding
*/
...
/*! http://en.wikipedia.org/wiki/UTF-32
        \tparam Ch Type for storing 32-bit UTF-32 data. Default is unsigned.
...
/*! \class rapidjson::Stream
        ...
        For read-only stream, no need to implement PutBegin(), Put() and
PutEnd().
