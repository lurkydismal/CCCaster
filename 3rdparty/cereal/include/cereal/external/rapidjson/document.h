...
/*!
        A JSON value can be one of 7 types. This class is a variant type
   supporting these types.

        Use the Value if UTF8 and default allocator

        \tparam Encoding	Encoding of the value. (Even non-string values
   need to have the same encoding in a document)
...
public:
    ...
    typedef const Member* ConstMemberIterator; //!< Constant member iterator for
                                               //!< iterating in object.
...
public:
    ...
    */
    GenericValue( Type type ) {
        static const unsigned defaultFlags[ 7 ] = {
            ...
            kArrayFlag,
            kConstStringFlag,
            kNumberFlag | kIntFlag | kUintFlag | kInt64Flag | kUint64Flag |
                kDoubleFlag };
    ...
    */
    ...
    /*! \param name A string value as name of member.
        ...
        \note The ownership of name and value will be transfered to this object
       if success.
    */
    GenericValue& AddMember( GenericValue& name,
        ...
        if ( o.size >= o.capacity ) {
            if ( o.capacity == 0 ) {
                ...
                o.members = ( Member* )allocator.Malloc( o.capacity *
                                                         sizeof( Member ) );
            } else {
                SizeType oldCapacity = o.capacity;
                o.capacity *= 2;
                o.members = ( Member* )allocator.Realloc(
                    o.members, oldCapacity * sizeof( Member ),
    ...
    /*! \param name Name of member to be removed.
        ...
        \note Removing member is implemented by moving the last member. So the
       ordering of members is changed.
    */
...
Value a(kArrayType);
a.PushBack(123);
int x = a[0].GetInt();				// Error: operator[ is
ambiguous, as 0 also mean a null pointer of const char* type. int y =
a[SizeType(0)].GetInt();	// Cast to SizeType will work. int z =
a[0u].GetInt();				// This works too.
\endcode
    */
    ...
    /*! \param newCapacity	The capacity that the array at least need to
       have.
            \param allocator	The allocator for allocating memory. It must be
       the same one use previously.
            \return The value itself for fluent API.
    */
    ...
    /*! \param value		The value to be appended.
       ...
       the same one use previously.
        \return The value itself for fluent API.
        \note The ownership of the value will be transfered to this object if
       success.
    ...
    */
    ...
    /*! This version has better performance with supplied length, and also
       support string containing null character.
    ...
    */
    ...
    /*! This function adopts the GoF visitor pattern.
       ...
       GenericDocument, which is also a Handler.
    ...
    const GenericValue& Accept( Handler& handler ) const {
        switch ( GetType() ) {
            ...
            case kObjectType:
                ...
                for ( Member* m = data_.o.members;
                      m != data_.o.members + data_.o.size; ++m ) {
                    handler.String( m->name.data_.s.str, m->name.data_.s.length,
                                    false );
...
private:
    ...
    Member* FindMember( const Ch* name ) {
        ...
        for ( Member* member = o.members;
            ...
            if ( length == member->name.data_.s.length &&
                 memcmp( member->name.data_.s.str, name,
                         length * sizeof( Ch ) ) == 0 )
                return member;
    ...
    void SetArrayRaw( GenericValue* values,
        ...
        flags_ = kArrayFlag;
        data_.a.elements =
            ( GenericValue* )alloctaor.Malloc( count * sizeof( GenericValue ) );
    ...
    void SetObjectRaw( Member* members, SizeType count, Allocator& alloctaor ) {
        flags_ = kObjectFlag;
        data_.o.members =
            ( Member* )alloctaor.Malloc( count * sizeof( Member ) );
...
/*!
        ...
        \tparam Alloactor allocator for allocating memory for the DOM, and the
...
public:
    ...
    //! Constructor
    /*! \param allocator		Optional allocator for allocating stack
       memory.
    ...
    */
    ...
    /*! \tparam parseFlags Combination of ParseFlag (must not contain
       kParseInsituFlag).
...
private:
    ...
    friend class GenericReader< Encoding,
                                Allocator >; // for Reader to call the following
