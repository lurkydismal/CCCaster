...
HRESULT m_IDirect3DIndexBuffer9::QueryInterface( THIS_ REFIID riid,
                                                 void** ppvObj ) {
    if ( ( riid == IID_IDirect3DIndexBuffer9 || riid == IID_IUnknown ||
...
unsigned long m_IDirect3DIndexBuffer9::AddRef( THIS ) {
    return ProxyInterface->AddRef();
}

unsigned long m_IDirect3DIndexBuffer9::Release( THIS ) {
    return ProxyInterface->Release();
}

HRESULT m_IDirect3DIndexBuffer9::GetDevice(
...
HRESULT m_IDirect3DIndexBuffer9::SetPrivateData( THIS_ REFGUID refguid,
                                                 CONST void* pData,
...
HRESULT m_IDirect3DIndexBuffer9::GetPrivateData( THIS_ REFGUID refguid,
                                                 void* pData,
...
unsigned long m_IDirect3DIndexBuffer9::SetPriority( THIS_ unsigned long PriorityNew ) {
    return ProxyInterface->SetPriority( PriorityNew );
}

unsigned long m_IDirect3DIndexBuffer9::GetPriority( THIS ) {
...
HRESULT m_IDirect3DIndexBuffer9::Lock( THIS_ unsigned int OffsetToLock,
