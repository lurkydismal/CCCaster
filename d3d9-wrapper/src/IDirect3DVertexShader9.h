...
class m_IDirect3DVertexShader9 : public IDirect3DVertexShader9,
...
public:
    m_IDirect3DVertexShader9( LPDIRECT3DVERTEXSHADER9 pShader9,
    ...
    LPDIRECT3DVERTEXSHADER9 GetProxyInterface( void ) { return ProxyInterface; }
