...
class m_IDirect3DVolume9 : public IDirect3DVolume9,
...
public:
    m_IDirect3DVolume9( LPDIRECT3DVOLUME9 pVolume8,
                        m_IDirect3DDevice9Ex* pDevice )
        : ProxyInterface( pVolume8 ), m_pDeviceEx( pDevice ) {
        pDevice->ProxyAddressLookupTable->SaveAddress( this, ProxyInterface );
    }
    ~m_IDirect3DVolume9() {}

    LPDIRECT3DVOLUME9 GetProxyInterface( void ) { return ProxyInterface; }
