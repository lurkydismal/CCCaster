...
class m_IDirect3DCubeTexture9 : public IDirect3DCubeTexture9,
...
public:
    m_IDirect3DCubeTexture9( LPDIRECT3DCUBETEXTURE9 pTexture9,
    ...
    LPDIRECT3DCUBETEXTURE9 GetProxyInterface( void ) {
