...
uint16_t __declspec( dllexport ) native$getColorForRectangle(
...
uint16_t __declspec( dllexport ) native$drawRectangle(
    void** _callbackArguments ) {
    uint16_t l_returnValue = 0;
...
uint16_t __declspec( dllexport ) native$drawText( void** _callbackArguments ) {
    uint16_t l_returnValue = 0;
...
uint16_t __declspec( dllexport ) native$drawSprite(
    void** _callbackArguments ) {
    uint16_t l_returnValue = 0;
...
uint16_t __declspec( dllexport ) native$loadTextureFromMemory(
    void** _callbackArguments ) {
    uint16_t l_returnValue = 0;
