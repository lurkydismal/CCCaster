...
#define CC_LOOP_START_ADDR ( 0x40D330 )
        {
            ...
            static patch_t l_gameMainLoopCallbackPatch1 =
                patchCreate( MM_HOOK_CALL1_ADDR, l_gameMainLoopCallbackPatch,
...
#define DX_MUTED_VOLUME ( 0xFFFFD8F0u )

        {
            ...
            static patch_t l_SFXMutePatch1 = patchCreate(
...

        {
            ...
            static patch_t l_SFXMutePatch2 = patchCreate(
...

        {
            ...
            static patch_t l_SFXMutePatch3 = patchCreate(
...

        {
            ...
            static patch_t l_SFXMutePatch4 = patchCreate(
...

        {
            ...
            static patch_t l_SFXMutePatch5 = patchCreate(
...

        {
            ...
            static patch_t l_SFXMutePatch6 = patchCreate(
...

        {
            ...
            static patch_t l_SFXMutePatch7 = patchCreate(
...
#undef DX_MUTED_VOLUME
    ...
    // manually set it during rollback
    {
        ...
        static patch_t l_autoIntroStatePatch1 = patchCreate(
...

    {
        ...
        static patch_t l_bossStageFlashPatch1 = patchCreate(
    ...
    {
        {
            ...
            static patch_t l_initialConfigWindowPatch1 =
                patchCreate( 0x04A1D42, l_initialConfigWindowPatch,
...

        {
            ...
            static patch_t l_initialConfigWindowPatch2 =
                patchCreate( 0x04A1D4A, l_initialConfigWindowPatch,
                             sizeof( l_initialConfigWindowPatch ) );
        }
    }
