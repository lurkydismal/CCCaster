...
class MainUi : private Controller::Owner,
   ...
   private:
    ...
    void fetchCompleted( MainUpdater* updater,
                         const MainUpdater::Type& type ) override;

    void fetchFailed( MainUpdater* updater,
                      const MainUpdater::Type& type ) override;

    void fetchProgress( MainUpdater* updater,
