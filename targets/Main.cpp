...
int main( int argc, char* argv[] ) {
    ...
    static const Descriptor desc[] = {
        ...
        { Options::Tests, 0, "", "tests", Arg::None,
          "  --tests              Run unit tests and exit" },
        { Options::Stdout, 0, "", "stdout", Arg::None,
          "  --stdout,            Output logs to stdout" },
        { Options::Tunnel, 0, "", "tunnel", Arg::None,
          "  --tunnel             Force UDP tunnel" },
        { Options::Dummy, 0, "", "dummy", Arg::None,
          "  --dummy              Dummy with fake inputs" },
        { Options::PidLog, 0, "", "pidlog", Arg::None,
          "  --pidlog             Tag log files with the PID" },
        { Options::FakeUi, 0, "", "fake", Arg::None,
          "  --fake               Fake UI mode\n" },

        { Options::StrictVersion, 0, "S", "strict", Arg::None,
          "  --strict, -S         Strict version match, can be stacked up to 3 "
          "times.\n"
