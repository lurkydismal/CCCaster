...
class Protocol {
   public:
    ...
    // Decode a series of bytes into a message, consumed indicates the number of
    // bytes read. This returns null if the message failed to decode, NOTE
    // consumed will still be updated.
...
class Serializable {
   public:
    ...
    // Return a string representation of this message, defaults to the message
    // type
